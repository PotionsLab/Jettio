...
export default class extends Phaser.State {
  ...
  preload () {
    this.loaderBg = this.add.sprite(this.game.world.centerX, this.game.world.centerY, '/assets/images/loaderBg')
    this.loaderBar = this.add.sprite(this.game.world.centerX, this.game.world.centerY, '/assets/images/loaderBar')
